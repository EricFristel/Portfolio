            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-1 inner">
                    <h1 class="animated fadeInDown">
                        E<span style="color:#E04343;">r</span>ic<br/>
                        <span>Fri<span style="color:#FFE800">s</span>tel</span>
                    </h1><!-- Title -->
                    <h3 class="animated fadeInUp delay-05s"><span class="rotate">Développeur Web Fullstack</span></h3><!-- Text Rotator -->
                </div>
            </div>
            <!-- Learn More Button -->
            <div class="row">
